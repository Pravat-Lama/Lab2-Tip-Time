...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cost_of_service = findViewById(R.id.cost);
        calculate_button = findViewById(R.id.calculate_button);
        radioGroup = findViewById(R.id.tip_options);
        switch_tip = findViewById(R.id.switch_tip);
        ...
        calculate_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkedRadioButton == R.id.option_20) {
                    tip_percent = 0.2;
                } else if (checkedRadioButton == R.id.option_18) {
                    tip_percent = 0.18;
                } else if (checkedRadioButton == R.id.option_15) {
                    tip_percent = 0.15;
                }
                tip_amount = costAmount * tip_percent;
                if (switch_tip.isChecked()) {
